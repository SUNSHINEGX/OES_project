...
public class PaperDAO extends BaseHibernateDAO implements PaperDAO_Interface {
	...
	public List findByExample(Paper instance) {
		...
		try {
			List results = getSession().createCriteria(
					"com.online.domain.Paper").add(Example.create(instance))
					.list();
