...
public class StudentinfoDAO extends BaseHibernateDAO implements StudentinfoDAO_Interface {
	...
	public Studentinfo findById(java.lang.Integer id) {
		...
		try {
			Studentinfo instance = (Studentinfo) getSession().get(
					"com.online.domain.Studentinfo", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Studentinfo instance) {
		...
		try {
			List results = getSession().createCriteria(
					"com.online.domain.Studentinfo").add(
