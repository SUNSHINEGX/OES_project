...
public class QuestionDAO extends BaseHibernateDAO implements QuestionDAO_Interface{
	...
	public static final String EASY_LEVEL = "easyLevel";
	...
	public List findByExample(Question instance) {
		...
		try {
			List results = getSession().createCriteria(
					"com.online.domain.Question").add(Example.create(instance))
					.list();
	...
	public List findByMainContent(Object mainContent) {
		return findByProperty(MAIN_CONTENT, mainContent);
	}
	...
	public List findByEasyLevel(Object easyLevel) {
		return findByProperty(EASY_LEVEL, easyLevel);
	}
